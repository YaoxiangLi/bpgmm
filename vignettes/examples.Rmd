...
larger analysis. It focuses on inspecting one fitted object; model-selection
interpretation is handled in the model-selection article.
...
easy to inspect. The fitted likelihood contribution is
