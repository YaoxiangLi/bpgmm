...
This article shows how to inspect posterior samples after fitting `bpgmm`.
It complements the model-selection vignette: instead of introducing a larger
data set, it focuses on diagnostics that can be reused in applied analyses.

The chains in this vignette are deliberately short so that the article builds
quickly. In real work, use longer chains and inspect stability carefully.
...
same cluster across posterior samples. This is often more informative than a
single modal allocation.
