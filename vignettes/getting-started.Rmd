...
`vignette("data-preparation", package = "bpgmm")`.
...
The package website contains several articles that avoid repeating the same
task:
...
- use the variable-prioritization article after fitting, when you want to
  understand which variables separate the fitted clusters.
