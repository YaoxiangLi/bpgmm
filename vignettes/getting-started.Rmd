...
clustering. It targets three posterior inference goals described by Li, Lu, and
...
The model-and-sampler vignette records the corrected Gibbs and RJMCMC formulas
from Li, Lu, and Love (2021), including the eight PGMM covariance structures,
hyperparameter updates, and the split/combine move with per-coordinate signs.
