...
functions, including larger model-selection and exploratory
variable-prioritization examples, data-preparation guidance, and
posterior diagnostics for multiple chains.
