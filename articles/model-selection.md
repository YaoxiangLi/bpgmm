...
The generating model matches the paper’s mixture-of-factor-analyzers
form:
...
$`\{\mathrm{CCC}, \ldots, \mathrm{UUU}\}`$. The saved samples estimate
these posterior probabilities by empirical frequencies:
